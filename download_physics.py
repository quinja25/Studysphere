"""
Downloads all IB Physics past papers from arrib.qzz.io
Excludes French and Spanish language variants.
Run: python download_physics.py
"""
...
def get_physics_paths():
    ...
    print(f"Found {len(filtered)} physics files (2010-2025, May & November, English only).")
    return filtered
